...
namespace EPPlusTest
{
    ...
    public class AmanaIssues : TestBase
    {
        ...
        {
            // Arrange
            var xlsx = GetTestStream("TestDoc_VLookUpDateValue_xlsx.xlsx");
        ...
        [TestMethod]
        public void Using_text_formula_should_keep_decimals_in_german_format()
        {
            //ARRANGE
#if Core
            var dir = AppContext.BaseDirectory;
...
#endif
            var exlPackage =
                new ExcelPackage(new FileInfo(Path.Combine(dir, "Workbooks", "TestDoc_Textformat_xlsx.xlsx")));
            var ws = exlPackage.Workbook.Worksheets[0];
